...
const VISIBLE_SERVICE_KEYS = new Set([
  "software",
...
const VISIBLE_SERVICES = SERVICES.filter((service) =>
  VISIBLE_SERVICE_KEYS.has(service.key),
);
...
export default function Navbar({ locale = "en", dict = {} }) {
  ...
  const groceryMainHref = () => `/${locale}/product?page=1&limit=10`;
  const bulkPurchaseHref = () => `/${locale}/bulk-purchase?page=1&limit=10`;
  const bbqDeliveryHref = () =>
    `/${locale}/product?category=bbq&page=1&limit=10`;
  const nepaliProductHref = () =>
    `/${locale}/product?category=madeinnepal&page=1&limit=10`;
  ...
  return (
    ...
    >
      ...
      <div
        className="hidden lg:block"
        style={{
          background: "linear-gradient(90deg, #0f2a5e 0%, #1a4b8f 100%)",
        }}
      >
        <div className="mx-auto w-full max-w-none px-4 lg:w-[80vw] lg:px-6">
          <div
              ...
              if (item.type === "scroll") {
                return (
                  <button
                    ...
                    style={{
                      borderRight: idx !== 2 ? "1px solid #fed7aa" : "none",
                    }}
                  >
                    <span
                ...
                {!isLoggedIn ? (
                  ...
                  <>
                    <Link
                      ...
                      style={{ borderColor: "#fed7aa", color: "#1a2f5e" }}
                    >
                      <LayoutDashboard
                        className="h-4 w-4"
                        style={{ color: "#1a4b8f" }}
                    ...
                    <button
                      ...
                      style={
                        lc === locale
                          ...
                          : { background: "#ffedd5", color: "#374166" }
                      }
                    >
                      {LABELS[lc]}
                    </button>
