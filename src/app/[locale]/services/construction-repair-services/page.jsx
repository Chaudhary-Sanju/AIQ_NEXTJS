    ...
    return (
        <>
            <DynamicPerfectServicesHeroSection
                locale={locale}
                dict={dict}
                serviceKey="constructionRepairServices"
                imageName="office.jpg"
            />

            <PerfectServiceRequestForm
                locale={locale}
                serviceType="construction-repair-services"
                title={dict.perfectServiceForm["construction-repair-services"].title}
            />

            <FAQSection
                locale={locale}
                page="home-office-services"
                dict={dict}
            />
